...
export declare function getOneUploadFile(files: UploadFile | UploadFile[]): UploadFile;
export declare function getUploadFiles(files: UploadFile | UploadFile[]): UploadFile[];
